...
class DefaultHL7Client
{
    ...
    private static ?DefaultHL7Client $instance = null;
    ...
    public static function getInstance(): DefaultHL7Client
    {
        if (self::$instance === null) {
            self::$instance = new DefaultHL7Client();
        }
